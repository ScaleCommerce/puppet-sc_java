...
3. [Setup - The basics of getting started with sc_java](#setup)
    * [What sc_java affects](#what-sc_java-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with sc_java](#beginning-with-sc_java)
